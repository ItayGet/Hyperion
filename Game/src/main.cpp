...
int main(void) {
	...
	if (succ) {
		...
		//{
		//	{
		//		glm::vec3(1., 0., -5.), .25,  glm::vec3(.1, 0., 1.), 0.5,
		//		glm::vec3(.5, 0., -5.), .25,  glm::vec3(.75, .75, .75), 1.,
		//		glm::vec3(0., 0., -5.), .25,  glm::vec3(.5, .5, .5), 2.,
		//		glm::vec3(-.5, 0., -5.), .25,  glm::vec3(.25, .25, .25), 3.,
		//		glm::vec3(-1., 0., -5.), .25,  glm::vec3(0., 1., 0.), 4.,
		//	},
		//	5
		//};
		while (a.update()) {
